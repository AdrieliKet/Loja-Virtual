...
const Marca = () => {
    ...
    const leftToolbarTemplate = () => {
        ...
        <React.Fragment>
            <div className='my-2'>
                <Button label="Nova Marca" icon="pi pi-plus" className='p-button-success' onClick={openNew}/>
            </div>
        </React.Fragment>
        );
    }
...
<DataTable ref={dt} value={objetos} dataKey="id" paginator rows={10} rowsPerPageOptions={[5, 10, 25]} className="datatable-responsive"
                    ...
                    <Dialog visible={objetoDialog} style={{ width: '450px' }} footer={objetoDialogFooter} header="Cadastro de Marcas" modal className="p-fluid" onHide={hideDialog}>
                        <div className="field">
